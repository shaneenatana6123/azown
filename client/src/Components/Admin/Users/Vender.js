          ...
          <div className="_prt_filt_dash">
            ...
            <div className="_prt_filt_dash_last m2_hide">
              ...
              <div className="_prt_filt_add_new">
                <a href="submit-property-dashboard.html" className="prt_submit_link"><i className="fas fa-plus-circle" /><span className="d-none d-lg-block d-md-block">Create Vender</span></a>
              </div>
            </div>
          </div>
        </div>
