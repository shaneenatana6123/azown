              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="m2_hide">
                    <div className="_leads_view"><h5 className="up">Visiter</h5></div>
                    <div className="_leads_view_title"><span>Type</span></div>
                  </td>
                  <td className="m2_hide">
                    <div className="_leads_posted"><h5>16 Aug - 12:40</h5></div>
                    <div className="_leads_view_title"><span>On Date</span></div>
                  </td>
                  <td>
                    <div className="_leads_status"><span className="active">View</span></div>
