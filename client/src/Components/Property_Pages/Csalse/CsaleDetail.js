...
const CsaleDetail = () => {
            ...
            <div className="property_info_detail_wrap_first">
              <div className="pr-price-into">
                <ul className="prs_lists">
                  <li><span className="bed">{data.cs_detail_property_type}</span></li>
                  <li><span className="bath">{data.cs_detail_building_type}</span></li>
                  <li><span className="gar">{data.cs_detail_furnishing}</span></li>
                  {/* <li><span className="sqft">800 sqft</span></li> */}
                </ul>
                <h2>{`${data.cs_detail_property_type} for rent in ${data.cs_location_city && data.cs_location_city.split(",")[0]}`}</h2>
          ...
          <div className="property_block_wrap">
            ...
            <div className="block-body">
              <ul className="row p-0 m-0">
                <li className="col-lg-6 col-md-6 mb-2 p-0"><img src="assets/icons/office-building.png" className="icon-details mr-1" />Property Type</li><p className='col-6'>{data.cs_detail_property_type}</p><hr />
                <li className="col-lg-6 col-md-6 mb-2 p-0"><img src="assets/icons/buildingpro.png" className="icon-details mr-1" />Building type</li><p className='col-6'>{data.cs_detail_building_type}</p><hr />
                <li className="col-lg-6 col-md-6 mb-2 p-0"><img src="assets/icons/cake.png" className="icon-details mr-1" />Property Age</li><p className='col-6'>{data.cs_detail_prop_age}</p><hr />
                <li className="col-lg-6 col-md-6 mb-2 p-0"><img src="assets/icons/building.png" className="icon-details mr-1" />Floor</li><p className='col-6'>{data.cs_detail_floor} Floor</p><hr />
                <li className="col-lg-6 col-md-6 mb-2 p-0"><img src="assets/icons/all.png" className="icon-details mr-1" />Total Floor</li><p className='col-6'>{data.cs_detail_total_floor} Total Floor</p><hr />
                <li className="col-lg-6 col-md-6 mb-2 p-0"><img src="assets/icons/scale-screen.png" className="icon-details mr-1" />built-up Area</li><p className='col-6'>{data.cs_detail_builtup_area} sqft.</p><hr />
                <li className="col-lg-6 col-md-6 mb-2 p-0"><img src="assets/icons/armchair.png" className="icon-details mr-1" />Furnishing</li><p className='col-6'>{data.cs_detail_furnishing}</p><hr />
              </ul>
            </div>
          </div>
          ...
          <div className="property_block_wrap">
            ...
            <div className="block-body">
              <ul className="avl-features third">
                <li className={data.cs_amenities_lift?"active":""}>Lift</li>
                <li className={data.cs_amenities_parking?"active":""}>Parking</li>
                <li className={data.cs_amenities_washroom?"active":""}>Wahroom</li>
                <li className={data.cs_amenities_power_backup?"active":""}>Power Backup</li>
                <li className={data.cs_amenities_security?"active":""}>Security</li>
                <li className={data.cs_amenities_wifi?"active":""}>WiFI</li>
                <li className={data.cs_amenities_water_storage?"active":""}>Water Storage</li>
              </ul>
            </div>
          </div>
                  ...
                  <div className="col-lg12 col-md-12 col-sm-12 mt-3">
                    ...
                    <div className="_adv_features">
                      <ul>
                        ...
                        <li>Expected Deposit<span>Rs.{data.cs_resale_details_exp_price}</span></li>
                      </ul>
                    </div>
                  </div>
                  <div className="side-booking-foot">
                    <span className="sb-header-left">Total Payment</span>
                    <h3 className="price theme-cl">${data.cs_resale_details_exp_price}</h3>
                  </div>
  ...
  {model && <div>
        ...
        <div className="mfp-wrap mfp-gallery mfp-auto-cursor mfp-fade mfp-ready" tabIndex={-1} style={{ overflow: 'hidden', }}>
