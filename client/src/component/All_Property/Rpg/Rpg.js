    ...
    <div class="p-2 ">
      <div class=" card mb-3" style={{ boxShadow: "1px 4px 6px 2px  gray ", background: "f8f8f8", padding: "25px" }}>
        <div className="row" style={{ borderBottom: "2px solid lightgray" }}>
          <div class="col-sm-9" >
            <h5 className="fs-8 mb-0"> <b>{property.rpg_detail_description}</b> <i class="fa-solid fs-4 fa-square-arrow-up-right"></i> </h5>
        ...
        <div class="row g-0 m-1">
          ...
          <div class="col-md-8 p-2">
            ...
            <div className="row m-2 mb-0">
              ...
              <Link className="btn btn-outline-dark col-md-2 m-1 " style={{ borderRadius: "0px" }} to={`/rpg-detail/${property._id}`}>
                More
              </Link>
