      ...
      <div className="container " style={{marginTop:"5%"}}>
        <div className="row">
          ...
          <div className="col-md-4 col1">
            <h6 className="dtl">{cmsdata.rr_detail_description}</h6>
            <p className="txt1">{cmsdata.rr_location_city}, {cmsdata.rr_location_state}</p>
          </div>
          <div className="col-md-2 col1">
            <h6 className="ptr7">₹{cmsdata.rr_rental_detail_rent}/M+<span> </span></h6>
            <div><small>Negotiable</small></div>
          </div>
          <div className="col-md-2 col1">
            <h6 className="ptr7">{cmsdata.rr_detail_builtup_area}</h6>
            <div><small>Sq.Ft</small></div>
          </div>
          <div className="col-md-2 col1">
            <h6 className="ptr7">₹ {cmsdata.rr_rental_detail_exp_deposit}</h6>
            ...
            <div className="row r1">
              <div className="col-sm-6 col-xs-6 sm6">
                <div className="row smin6">
                  ...
                  <div className="col-sm-9">
                    <div><b>{cmsdata.rr_detail_bhk_type}</b><br /><span className="sml10"> No. of Bedroom</span></div>
                  </div>
                </div>
              </div>
              <div className="col-sm-6 col-xs-6 sm6">
                <div className="row smin6">
                  ...
                  <div className="col-sm-9 ">
                    <div><b>{cmsdata.rr_detail_app_type}</b><br /><span className="sml10"> Apartment Type</span></div>
                  </div>
                </div>
              </div>
              <div className="col-sm-6 sm6">
                <div className="row smin6">
                  ...
                  <div className="col-sm-9">
                    <div><b>{cmsdata.rr_rental_detail_pref_tenent}</b><br /><span className="sml10"> Prefer Tenants</span></div>
                  </div>
                </div>
              </div>
              <div className="col-sm-6 sm6">
                <div className="row smin6">
                  ...
                  <div className="col-sm-9">
                    <div><b>{cmsdata.rr_rental_detail_avail_from}</b><br /><span className="sml10"> Available From</span></div>
                  </div>
                </div>
              </div>
              <div className="col-sm-6 sm6">
                <div className="row smin6">
                  ...
                  <div className="col-sm-9">
                    <div><b>{cmsdata.rr_deatil_parking}</b><br /><span className="sml10"> Parking</span></div>
                  </div>
                </div>
              </div>
              <div className="col-sm-6 sm6">
                <div className="row smin6">
                  ...
                  <div className="col-sm-9">
                    <div><b>{cmsdata.rr_detail_prop_age}</b><br /><span className="sml10">Age Of Building</span></div>
                  </div>
                </div>
              </div>
              <div className="col-sm-6 sm6">
                <div className="row smin6">
                  ...
                  <div className="col-sm-9">
                    <div><b>{cmsdata.rr_detail_balcony}</b><br /><span className="sml10"> No of Balcony</span></div>
                  </div>
                </div>
              </div>
              <div className="col-sm-6 sm6">
                <div className="row smin6">
                  <div className="col-sm-3"><i class="fa-solid fa-calendar-days fs-3 p-2"></i></div>
                  <div className="col-sm-9">
                    <div><b>{cmsdata.date}</b><br /><span className="sml10"> Post Date</span></div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="row"><div className="col-sm-12"><h3 className="ove">Overview</h3></div></div><br/>
              ...
              <div className="row">
                ...
                <div className="col-sm-3">
                  ...
                  <p>{cmsdata.rr_detail_furnishing}</p>
              ...
              <div className="row">
                ...
                <div className="col-sm-3">
                  ...
                  <p>{cmsdata.rr_detail_floor}/{cmsdata.rr_detail_total_floor}</p>
              ...
              <div className="row">
                ...
                <div className="col-sm-3">
                  ...
                  <p>{cmsdata.rr_detail_bathroom}</p>
                ...
                <div className="col-sm-3">
                  ...
                  <p>{cmsdata.rr_rental_detail_is_allowed_nonveg}</p>
              ...
              <div className="row">
                ...
                <div className="col-sm-3">
                  ...
                  <p>{cmsdata.rr_amenities_gated_security}</p>
